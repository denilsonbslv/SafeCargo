...
namespace SafeCargo.Server.Data.Migrations
{
    ...
    [Migration("20240610224505_SeedDefaultAccessLevelAndUser")]
    partial class SeedDefaultAccessLevelAndUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SafeCargo.Server.Models.AccessLevel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CodLevel = "ADMIN",
                            CreatedAt = new DateTime(2024, 6, 10, 22, 45, 5, 112, DateTimeKind.Utc).AddTicks(7061),
            ...
            modelBuilder.Entity("SafeCargo.Server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CodLevel = "ADMIN",
                            CreatedAt = new DateTime(2024, 6, 10, 22, 45, 5, 113, DateTimeKind.Utc).AddTicks(8687),
                            PasswordHash = "jl3O8QjBKZMBlNb07vZotQ==.vbYYRwItOdoc5Yq873kcuZjSnA2e+YLoHhPDFe3Wf0I=",
                            Username = "admin"
                        });
                });
